...
function playSound(name) {
    var audio = new Audio("./Memory_Game/sounds/" + name + ".mp3");
    audio.play();
}
...
function checkAnswer(currentLevel) {
    if (userClickedPattern[currentLevel] === gamePattern[currentLevel]) {
        ...
        var waudio = new Audio("./Memory_Game/sounds/wrong.mp3");
        ...
        waudio.play();
        startOver();
        // Handle game over situation here, reset game variables, show "Game Over" message, etc.
    }
}
